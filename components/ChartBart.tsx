          ...
          {["desktop", "mobile"].map((key) => {
            ...
            return (
              <button
                ...
                className="data-[active=true]:bg-muted/50 relative z-10 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left even:border-l sm:border-t-0 sm:border-l sm:px-8 sm:py-6"
